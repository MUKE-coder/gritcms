...
export default function BlogTagPage() {
  ...
  const { data, isLoading } = usePublicPosts({ page, pageSize: 9, tag: slug });
    ...
    <div className="mx-auto max-w-5xl px-6 py-16">
      ...
      <div className="mb-10">
        <h1 className="text-4xl font-bold tracking-tight">
          <span className="text-text-muted">#</span>{slug}
        </h1>
        <p className="mt-2 text-text-secondary">
          Posts tagged with &ldquo;{slug}&rdquo;
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          <h3 className="text-lg font-semibold text-foreground">No posts with this tag</h3>
